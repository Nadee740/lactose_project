                        ...
                        children: [
                          Container(
                            child: Align(
                              ...
                              child: Text(
                                "About Doctor",
                                style: TextStyle(fontSize: 25, fontFamily: 'f'),
                              ),
                            ),
                          ),
                          Padding(
                          ...
                          Align(
                            ...
                            child: Text(
                              " and more recently withthe release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem ",
                              style: TextStyle(fontSize: 10, fontFamily: 'f'),
                            ),
                          ),
                        ],
                      ),
                            ...
                            Container(
                              child: Align(
                                ...
                                child: Text(
                                  "Time",
                                  style:
                                      TextStyle(fontSize: 25, fontFamily: 'f'),
                                ),
                              ),
                            ),
                            TimeRange(
...
showAlertDialog(BuildContext context) {
  ...
  Widget cancelButton = FlatButton(
    child: Text(
      "Cancel",
      style: TextStyle(fontFamily: 'f', fontSize: 21),
    ),
    onPressed: () {
      Navigator.pushReplacement(
          context,
